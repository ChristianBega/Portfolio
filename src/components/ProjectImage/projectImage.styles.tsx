...
import { ProjectImageContainerProps } from "./types";

export const StyledProjectImageContainer = styled.div<ProjectImageContainerProps & MediaQueries>`
  position: relative;
  width: 100%;
...
export const StyledProjectImageFrame = styled.img<MediaQueries & ProjectImageContainerProps>`
  width: 100%;
  height: 487.75px;
  max-width: 800px;
...
export const StyledProjectImage = styled.img<MediaQueries & ProjectImageContainerProps>`
  height: 465px;
  width: 215px;
  border-radius: 30px;
  position: absolute;
