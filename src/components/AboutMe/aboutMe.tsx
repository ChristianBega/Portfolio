      ...
      <TextBlock
        ...
        paragraph={[
          ...
          >
            ...
            JavaScript, and React JS with a mobile-first approach, ensuring my projects are responsive, efficient, and widely accessible.
          ...
          >
            My full-stack development knowledge enables seamless integration of 3rd party APIs into front-end platforms and the development of small
            to medium RESTful APIs. This expertise allows me to build robust, scalable solutions tailored to complex business needs while ensuring a
            smooth and engaging front-end experience.
          </Typography>,
        ]}
      />
    </GridItem>
